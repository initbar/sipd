...
class TestDebug(unittest.TestCase):
    ...
    def test_debug_sha512sum_string_small(self):
        sample = 'a'
        attempt = sha512sum(sample)
        answer = '1f40fc92da241694750979ee6cf582f2d5d7d28e18335de05abc54d0560e0f5302860c652bf08d560252aa5e74210546f369fbbbce8c12cfc7957b2652fe9a75'
        self.assertEqual(attempt, answer)

    def test_debug_sha512sum_string_medium(self):
        sample = 'hello'
        attempt = sha512sum(sample)
        answer = '9b71d224bd62f3785d96d46ad3ea3d73319bfbc2890caadae2dff72519673ca72323c3d99ba5c11d7c7acc6e14b8c5da0c4663475c2e5c3adef46f73bcdec043'
        self.assertEqual(attempt, answer)

    def test_debug_sha512sum_string_long(self):
        sample = 'A' * 0xfff
        attempt = sha512sum(sample)
        answer = '34e60053d4330246808246aa78cdbff2302361f25fea9f34a153cf33ed99604985a253031aa137f0c072fd8d71c9c411fda3be3b3ab33a18cdd61386ba75107c'
        self.assertEqual(attempt, answer)
