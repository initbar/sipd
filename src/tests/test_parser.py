...
class TestParser(unittest.TestCase):
    ...
    def test_parser_parse_sip_packet_single_header(self):
        ...
        self.assertEqual(
            ...
            {'sip': {
                'Content-Length': '0',
                'Via': 'SIP/2.0/UDP 105.21.3.40:15064;branch=z9hG4bK0x2473c35084b6b1',
                'From': '<sip:GVP@105.21.3.40:15064>;tag=9E565000-FB73-C996-4E01-0810C8DE0CF4',
                'Supported': 'timer, uui',
                'To': 'sip:105.20.3.73:5060',
                'Contact': '<sip:GVP@105.21.3.40:15064>',
                'CSeq': '307103 OPTIONS',
                'Allow': 'INVITE, OPTIONS, BYE, CANCEL, ACK, UPDATE, INFO',
                'Call-ID': '9E565000-FB73-F13E-6076-D8822FB9A4E4-15064@105.21.3.40',
                'Max-Forwards': '70',
                'Method': 'OPTIONS'},
             'sdp': []})
